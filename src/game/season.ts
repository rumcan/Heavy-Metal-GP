...
export const CALENDAR: GrandPrix[] = [
  ...
  { id: 4, name: 'Suzuka Spiral', short: 'SUZUKA', location: 'Suzuka Spiral', flag: '🇯🇵', desc: 'Spinners, splitters, flip-plates through the red-rock worg canyon. Technical and chaotic.', profile: P(11, { Spinners: 3, Splitter: 2.5, Funnel: 1.5, 'Switchback Lanes': 1.7, 'Blade Gauntlet': 1.6, 'Saw Slot': 1.4, 'Beltway': 1.6, 'Teeter Crossing': 1.2, 'Flipper Alley': 1.6, 'Sling Chute': 1.5, 'Vent Field': 1.3, 'Trampoline Alley': 1.2 }, 'worg') },
