...
export const CALENDAR: GrandPrix[] = [
  { id: 0, name: 'Marblehurst Grand Prix', short: 'MARBLEHURST', location: 'Marblehurst Park', flag: '🇬🇧', desc: 'The season opener. A balanced circuit with a bit of everything.', profile: P(10, { 'Rope Crossing': 1.4, 'Teeter Crossing': 1.3, 'Catapult Ledge': 1.4, 'Fan Garden': 1.3, 'Drawbridge Gap': 1.2 }, 'classic') },
