...
export const CALENDAR: GrandPrix[] = [
  ...
  { id: 3, name: 'Spa-Francoroll', short: 'SPA', location: 'Ardennes Chutes', flag: '🇧🇪', desc: 'The fastest track of the year. Ice slides, boost pads and the odd cliff burrow.', profile: P(12, { 'Ice Slide': 3, 'Zigzag Pipes': 2, Splitter: 1.5, 'Peg Field': 0.3, 'Tunnel Shortcut': 1.4 }, 'forest') },
  { id: 4, name: 'Suzuka Spiral', short: 'SUZUKA', location: 'Suzuka Spiral', flag: '🇯🇵', desc: 'Spinners and splitters through the red-rock worg canyon. Technical and chaotic.', profile: P(11, { Spinners: 3, Splitter: 2.5, Funnel: 1.5, 'Switchback Lanes': 1.7 }, 'worg') },
...
=======
  { id: 3, name: 'Spa-Francoroll', short: 'SPA', location: 'Ardennes Chutes', flag: '🇧🇪', desc: 'The fastest track of the year. Ice slides, boost pads and the odd cliff burrow.', profile: P(12, { 'Ice Slide': 3, 'Zigzag Pipes': 2, Splitter: 1.5, 'Peg Field': 0.3, 'Tunnel Shortcut': 1.4, 'Boulder Run': 1.4 }, 'forest') },
  { id: 4, name: 'Suzuka Spiral', short: 'SUZUKA', location: 'Suzuka Spiral', flag: '🇯🇵', desc: 'Spinners, splitters, flip-plates. Technical and chaotic.', profile: P(11, { Spinners: 3, Splitter: 2.5, Funnel: 1.5, 'Switchback Lanes': 1.7, 'Blade Gauntlet': 1.6, 'Saw Slot': 1.4 }, 'sakura') },
  { id: 5, name: 'Yas Marble Finale', short: 'YAS MARBLE', location: 'Yas Marble Island', flag: '🏁', desc: 'The night-race finale. The longest track — every feature, every trick, every secret and every blade.', profile: P(14, { 'Crack Wall Shortcut': 1.6, 'Bounce Ramp': 1.6, 'Peggle Board': 1.5, 'Tunnel Shortcut': 1.3, 'Switchback Lanes': 1.3, 'Crumbling Wall': 1.2, 'Trapdoor Drop': 1.2, 'Blade Gauntlet': 1.2, 'Saw Slot': 1.2, 'Crusher Alley': 1.2, 'Boulder Run': 1.3, 'Mace Sweep': 1.2 }, 'night') },
