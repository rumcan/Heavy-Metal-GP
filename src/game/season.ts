...
export const CALENDAR: GrandPrix[] = [
  ...
  { id: 1, name: 'Monte Pipo Street Circuit', short: 'MONTE PIPO', location: 'Monte Pipo Harbour', flag: '🇲🇨', desc: 'Tight chicanes, crumbling walls — overtaking is hard, secret chutes help.', profile: P(11, { Chicane: 3, Funnel: 2.5, 'Zigzag Pipes': 1.5, 'Ice Slide': 0.2, Splitter: 0.3, 'Crumbling Wall': 1.6, 'Trapdoor Drop': 1.3 }, 'street') },
...
=======
  ...
  { id: 4, name: 'Suzuka Spiral', short: 'SUZUKA', location: 'Suzuka Spiral', flag: '🇯🇵', desc: 'Spinners, splitters, flip-plates. Technical and chaotic.', profile: P(11, { Spinners: 3, Splitter: 2.5, Funnel: 1.5, 'Switchback Lanes': 1.7 }, 'sakura') },
  { id: 5, name: 'Yas Marble Finale', short: 'YAS MARBLE', location: 'Yas Marble Island', flag: '🏁', desc: 'The night-race finale. The longest track — every feature, every trick, every secret.', profile: P(14, { 'Crack Wall Shortcut': 1.6, 'Bounce Ramp': 1.6, 'Peggle Board': 1.5, 'Tunnel Shortcut': 1.3, 'Switchback Lanes': 1.3, 'Crumbling Wall': 1.2, 'Trapdoor Drop': 1.2 }, 'night') },
>>>>>>> 139fdd8 (MB-10A (#47): secret passage elements — barricade, cliff tunnel, crumbling wall, trapdoor, track switch)
];
