...
export const CALENDAR: GrandPrix[] = [
  ...
  { id: 3, name: 'Spa-Francoroll', short: 'SPA', location: 'Ardennes Chutes', flag: '🇧🇪', desc: 'The season\'s flowing speed event. Banked canopy chutes drop into an emerald oxbow you wade or bounce a rope bridge across, then a root-bound sprint splits the heavy channel from the fast outside line.', profile: P(12, { 'Ice Slide': 3, 'Zigzag Pipes': 2, Splitter: 1.5, 'Peg Field': 0.3, 'Tunnel Shortcut': 1.4, 'Boulder Run': 1.4, 'Screw Tower': 1.3, 'Scoop Subway': 0.9, 'Skipping Pools': 1.0, 'Vortex Bowl': 1.0 }, 'forest') },
