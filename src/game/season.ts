...
export const CALENDAR: GrandPrix[] = [
  { id: 0, name: 'Marblehurst Grand Prix', short: 'MARBLEHURST', location: 'Marblehurst Park', flag: '🇬🇧', desc: 'The season opener rebuilt as Goblin Switchback Fair — compact three-build routes and a jump-access screw shortcut into a fairground snake.', profile: P(10, { 'Rope Crossing': 1.4, 'Teeter Crossing': 1.3, 'Catapult Ledge': 1.4, 'Fan Garden': 1.3, 'Drawbridge Gap': 1.2 }, 'classic') },
  ...
  { id: 2, name: 'Silverpeg Grand Prix', short: 'SILVERPEG', location: 'Silverpeg Circuit', flag: '🎯', desc: 'Three purposeful peg lanes — boost bank, crate gauntlet, spring room — and a jump-to-conveyor bypass over the Resonator bowl.', profile: P(11, { 'Peggle Board': 3.5, 'Peg Field': 2.5, Chicane: 0.4, 'Lodestone Way': 1.2, 'Turnstile Square': 1.2 }, 'silver') },
  { id: 3, name: 'Spa-Francoroll', short: 'SPA', location: 'Ardennes Chutes', flag: '🇧🇪', desc: 'The fastest track of the year. Ice slides, boost pads and the odd cliff burrow.', profile: P(12, { 'Ice Slide': 3, 'Zigzag Pipes': 2, Splitter: 1.5, 'Peg Field': 0.3, 'Tunnel Shortcut': 1.4, 'Boulder Run': 1.4, 'Screw Tower': 1.3, 'Scoop Subway': 0.9, 'Skipping Pools': 1.0, 'Vortex Bowl': 1.0 }, 'forest') },
  { id: 4, name: 'Suzuka Spiral', short: 'SUZUKA', location: 'Suzuka Spiral', flag: '🇯🇵', desc: 'A bone fork of three momentum lanes, the Windscar lift shuttling its chamber, and a blade-and-mace slalom — short alternating control decisions all the way down.', profile: P(11, { Spinners: 3, Splitter: 2.5, Funnel: 1.5, 'Switchback Lanes': 1.7, 'Blade Gauntlet': 1.6, 'Saw Slot': 1.4, 'Beltway': 1.6, 'Teeter Crossing': 1.2, 'Flipper Alley': 1.6, 'Sling Chute': 1.5, 'Vent Field': 1.3, 'Trampoline Alley': 1.2 }, 'worg') },
  { id: 5, name: 'Yas Marble Finale', short: 'YAS MARBLE', location: 'Yas Marble Island', flag: '🏁', desc: 'Yas Marble Crucible — three forge pressure routes, a jump wheel bypass and a short tactical finale. Pick boost, weight or spring through the foundries, then choose outer forge road, inner pressure channel or wheel conveyor express through Crucible Crossing.', profile: P(14, { 'Crack Wall Shortcut': 1.6, 'Bounce Ramp': 1.6, 'Peggle Board': 1.5, 'Tunnel Shortcut': 1.3, 'Switchback Lanes': 1.3, 'Crumbling Wall': 1.2, 'Trapdoor Drop': 1.2, 'Blade Gauntlet': 1.2, 'Saw Slot': 1.2, 'Crusher Alley': 1.2, 'Boulder Run': 1.3, 'Mace Sweep': 1.2, 'Wheel Lift': 1.1, 'Screw Tower': 1.1, 'Beltway': 1.1, 'Teeter Crossing': 1.1, 'Rope Crossing': 1.1, 'Cannon Run': 1.1, 'Catapult Ledge': 1.05, 'Flipper Alley': 1.05, 'Sling Chute': 1.05, 'Scoop Subway': 1.05, 'Fan Garden': 1.05, 'Lodestone Way': 1.0, 'Tar Flats': 1.0, 'Skipping Pools': 1.0, 'Vent Field': 1.0, 'Trampoline Alley': 1.0, 'Turnstile Square': 0.9, 'Target Gate': 0.9, 'Vortex Bowl': 0.9, 'Drawbridge Gap': 1.0 }, 'dwarven') },
];
