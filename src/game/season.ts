...
export const CALENDAR: GrandPrix[] = [
  ...
  { id: 2, name: 'Silverpeg Grand Prix', short: 'SILVERPEG', location: 'Silverpeg Circuit', flag: '🎯', desc: 'A Peggle paradise. Peg fields and pop-boards everywhere.', profile: P(11, { 'Peggle Board': 3.5, 'Peg Field': 2.5, Chicane: 0.4, 'Lodestone Way': 1.2, 'Turnstile Square': 1.2 }, 'silver') },
