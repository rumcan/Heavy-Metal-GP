...
export const CALENDAR: GrandPrix[] = [
  ...
  { id: 1, name: 'Monte Pipo Street Circuit', short: 'MONTE PIPO', location: 'Monte Pipo Harbour', flag: '🇲🇨', desc: 'A harbour heist in three acts: loft the rooftops or bully the cargo cut, catch the hoist ferry across the docks, then thread the crane lane past the mace. Every line rejoins — pick yours fast.', profile: P(11, { Chicane: 3, Funnel: 2.5, 'Zigzag Pipes': 1.5, 'Ice Slide': 0.2, Splitter: 0.3, 'Crumbling Wall': 1.6, 'Trapdoor Drop': 1.3, 'Crusher Alley': 1.5, 'Mace Sweep': 1.2, 'Wheel Lift': 1.5, 'Cannon Run': 1.5, 'Tar Flats': 1.2, 'Target Gate': 1.2 }, 'street') },
