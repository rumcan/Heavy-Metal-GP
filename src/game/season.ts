...
export const CALENDAR: GrandPrix[] = [
  { id: 0, name: 'Marblehurst Grand Prix', short: 'MARBLEHURST', location: 'Marblehurst Park', flag: '🇬🇧', desc: 'The season opener. A balanced circuit with a bit of everything.', profile: P(10, { 'Rope Crossing': 1.4, 'Teeter Crossing': 1.3, 'Catapult Ledge': 1.4 }, 'classic') },
  { id: 1, name: 'Monte Pipo Street Circuit', short: 'MONTE PIPO', location: 'Monte Pipo Harbour', flag: '🇲🇨', desc: 'Tight chicanes, crumbling walls, stamping pistons — overtaking is hard, secret chutes help.', profile: P(11, { Chicane: 3, Funnel: 2.5, 'Zigzag Pipes': 1.5, 'Ice Slide': 0.2, Splitter: 0.3, 'Crumbling Wall': 1.6, 'Trapdoor Drop': 1.3, 'Crusher Alley': 1.5, 'Mace Sweep': 1.2, 'Wheel Lift': 1.5, 'Cannon Run': 1.5 }, 'street') },
  ...
  { id: 3, name: 'Spa-Francoroll', short: 'SPA', location: 'Ardennes Chutes', flag: '🇧🇪', desc: 'The fastest track of the year. Ice slides, boost pads and the odd cliff burrow.', profile: P(12, { 'Ice Slide': 3, 'Zigzag Pipes': 2, Splitter: 1.5, 'Peg Field': 0.3, 'Tunnel Shortcut': 1.4 , 'Screw Tower': 1.3}, 'forest') },
  { id: 4, name: 'Suzuka Spiral', short: 'SUZUKA', location: 'Suzuka Spiral', flag: '🇯🇵', desc: 'Spinners and splitters through the red-rock worg canyon. Technical and chaotic.', profile: P(11, { Spinners: 3, Splitter: 2.5, Funnel: 1.5, 'Switchback Lanes': 1.7 , 'Beltway': 1.6, 'Teeter Crossing': 1.2}, 'worg') },
  { id: 5, name: 'Yas Marble Finale', short: 'YAS MARBLE', location: 'Yas Marble Island', flag: '🏁', desc: 'The finale, deep in the dwarven forge. The longest track — every feature, every trick, every secret.', profile: P(14, { 'Crack Wall Shortcut': 1.6, 'Bounce Ramp': 1.6, 'Peggle Board': 1.5, 'Tunnel Shortcut': 1.3, 'Switchback Lanes': 1.3, 'Crumbling Wall': 1.2, 'Trapdoor Drop': 1.2 , 'Wheel Lift': 1.1, 'Screw Tower': 1.1, 'Beltway': 1.1, 'Teeter Crossing': 1.1, 'Rope Crossing': 1.1}, 'dwarven') },
>>>>>>> 9d2ac40 (MB-10B (#48): danger & machinery — swinging blade, saw blade, crusher piston, rolling boulder, mace sweeper)
>>>>>>> 9d2ac40 (MB-10B (#48): danger & machinery — swinging blade, saw blade, crusher piston, rolling boulder, mace sweeper)
=======
  { id: 3, name: 'Spa-Francoroll', short: 'SPA', location: 'Ardennes Chutes', flag: '🇧🇪', desc: 'The fastest track of the year. Ice slides, boost pads and the odd cliff burrow.', profile: P(12, { 'Ice Slide': 3, 'Zigzag Pipes': 2, Splitter: 1.5, 'Peg Field': 0.3, 'Tunnel Shortcut': 1.4, 'Boulder Run': 1.4, 'Screw Tower': 1.3 }, 'forest') },
  { id: 4, name: 'Suzuka Spiral', short: 'SUZUKA', location: 'Suzuka Spiral', flag: '🇯🇵', desc: 'Spinners, splitters, flip-plates. Technical and chaotic.', profile: P(11, { Spinners: 3, Splitter: 2.5, Funnel: 1.5, 'Switchback Lanes': 1.7, 'Blade Gauntlet': 1.6, 'Saw Slot': 1.4, 'Beltway': 1.6, 'Teeter Crossing': 1.2 }, 'sakura') },
  { id: 5, name: 'Yas Marble Finale', short: 'YAS MARBLE', location: 'Yas Marble Island', flag: '🏁', desc: 'The night-race finale. The longest track — every feature, every trick, every secret and every blade.', profile: P(14, { 'Crack Wall Shortcut': 1.6, 'Bounce Ramp': 1.6, 'Peggle Board': 1.5, 'Tunnel Shortcut': 1.3, 'Switchback Lanes': 1.3, 'Crumbling Wall': 1.2, 'Trapdoor Drop': 1.2, 'Blade Gauntlet': 1.2, 'Saw Slot': 1.2, 'Crusher Alley': 1.2, 'Boulder Run': 1.3, 'Mace Sweep': 1.2, 'Wheel Lift': 1.1, 'Screw Tower': 1.1, 'Beltway': 1.1, 'Teeter Crossing': 1.1, 'Rope Crossing': 1.1 }, 'night') },
>>>>>>> 747ce11 (MB-10C (#49): movers — water wheel, Archimedes screw, conveyor, seesaw, rope bridge)
=======
  { id: 3, name: 'Spa-Francoroll', short: 'SPA', location: 'Ardennes Chutes', flag: '🇧🇪', desc: 'The fastest track of the year. Ice slides, boost pads and the odd cliff burrow.', profile: P(12, { 'Ice Slide': 3, 'Zigzag Pipes': 2, Splitter: 1.5, 'Peg Field': 0.3, 'Tunnel Shortcut': 1.4, 'Boulder Run': 1.4, 'Screw Tower': 1.3, 'Scoop Subway': 0.9 }, 'forest') },
  { id: 4, name: 'Suzuka Spiral', short: 'SUZUKA', location: 'Suzuka Spiral', flag: '🇯🇵', desc: 'Spinners, splitters, flip-plates. Technical and chaotic.', profile: P(11, { Spinners: 3, Splitter: 2.5, Funnel: 1.5, 'Switchback Lanes': 1.7, 'Blade Gauntlet': 1.6, 'Saw Slot': 1.4, 'Beltway': 1.6, 'Teeter Crossing': 1.2, 'Flipper Alley': 1.6, 'Sling Chute': 1.5 }, 'sakura') },
  { id: 5, name: 'Yas Marble Finale', short: 'YAS MARBLE', location: 'Yas Marble Island', flag: '🏁', desc: 'The night-race finale. The longest track — every feature, every trick, every secret and every blade.', profile: P(14, { 'Crack Wall Shortcut': 1.6, 'Bounce Ramp': 1.6, 'Peggle Board': 1.5, 'Tunnel Shortcut': 1.3, 'Switchback Lanes': 1.3, 'Crumbling Wall': 1.2, 'Trapdoor Drop': 1.2, 'Blade Gauntlet': 1.2, 'Saw Slot': 1.2, 'Crusher Alley': 1.2, 'Boulder Run': 1.3, 'Mace Sweep': 1.2, 'Wheel Lift': 1.1, 'Screw Tower': 1.1, 'Beltway': 1.1, 'Teeter Crossing': 1.1, 'Rope Crossing': 1.1, 'Cannon Run': 1.1, 'Catapult Ledge': 1.05, 'Flipper Alley': 1.05, 'Sling Chute': 1.05, 'Scoop Subway': 1.05 }, 'night') },
>>>>>>> 894ede3 (MB-10D (#50): launchers — goblin cannon, catapult, pinball flipper, slingshot kicker, scoop & subway)
];
