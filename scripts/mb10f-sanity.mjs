...
// Usage: node --import tsx scripts/mb10f-sanity.mjs
...
for (const [name, kind] of [['Trampoline Alley', 'trampoline'], ['Turnstile Square', 'turnstile'], ['Target Gate', 'targets'], ['Vortex Bowl', 'vortex'], ['Drawbridge Gap', 'platform']]) {
...
console.log('MB-10F sanity: all clear');
